...
export const Card: FC<CardProps> = ({ playerColourIndex = 1, className, children }) => {
  ...
  return (
    <div className={twMerge('card relative origin-bottom', className)}>
      <div
        className="absolute -top-1.5 -left-1.5 size-full"
        style={{
          background: oklchGradient,
        }}
      />
      <div
        className="relative flex h-full flex-col gap-2.5 bg-linear-160 from-white from-35% to-white/85 p-4 text-black sm:p-8"
        style={{
